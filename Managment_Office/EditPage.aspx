<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="EditPage.aspx.cs" Inherits="Managment_Office.EditPage" %>
...
<section class="forms">
					...
					<div class="col-sm-12">
						<div class="panel wow bounceInDown"  data-wow-duration="2s" data-wow-offset="200">
							<div class="panel-body">
								 <div class="alert alert-success" id="r" runat="server" style="background-color:green;width:100%;text-align: center;font-weight:bold;color:white" visible="false">تم التعديل بنجاح <span style="font-size:20px;" onclick="fun();"> 
                                ...
                                <h2>التحويل الرقمي لقسم الكيمياء</h2>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-8">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" SetFocusOnError="true" ControlToValidate="txtSearch" runat="server" ForeColor="Red" ErrorMessage=" برجاء ادخال / اختيار جهة الصادر"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-8">
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" SetFocusOnError="true" ControlToValidate="exdate" runat="server" ForeColor="Red" ErrorMessage="برجاء ادخال تاريخ الصادر"></asp:RequiredFieldValidator>
                                                       <input type="date" id="exdate" runat="server" class="form-control" />
												</div>
                                            </div>
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-8">
                                                    ...
                                                    <input type="date" id="impDate" runat="server" class="form-control" />
												</div>
											</div>
                                           <div class="form-group">
											...
											<div class="form-group">
												<label class="col-xs-12 col-sm-3 col-form-label" style="margin-top:20px" for="data"> البيان <span class="stark">*</span></label>
												<div class="col-xs-12 col-sm-8">
                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="textbyan" runat="server" ForeColor="Red" ErrorMessage="برجاء ادخال البيان"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="form-group">
											 ...
											 <%--  ---------------folder name-------------%>
                                            <div class="form-group">
												<label class="col-xs-12 col-sm-3 col-form-label" for="fold" style="color:#980000 !important;">اسم المجلد</label>
												<div class="col-xs-12 col-sm-8">
                                             ...
                                             <div class="form-group">
                                               ...
                                               <asp:ListItem Text="غير منتهي" Value="2" />
                                                ...
                                                <asp:RequiredFieldValidator CssClass="col-xs-12 col-sm-5" ID="RequiredFieldValidator2" SetFocusOnError="true" ErrorMessage="برجاء اختيار حالة الانتهاء"
    ...
    {%>
                                            ...
                                            <%} %>
										<div class="form-group">
												<label class="col-xs-12 col-sm-3 col-form-label" for="photoo"> الملف: PDF/image </label>
												<div class="col-xs-12 col-sm-8">
													...
													<asp:Button runat="server" ID="del"  OnClick="del_Click" Text="حذف الصورة / الملف"  cssClass="btn btn-danger" style="background-color: darkred; color: white;padding-left: 48px;padding-right: 48px;padding-bottom: 9px !important;"/>
   ...
   <%-- <button runat="server" id="dr"   style="" onclick="s();" >show modal</button>
 --%>   
...
-<div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-body">
            <button type="button" class="close" >&times;</button>
             <p> تم الحفظ بنجاح </p>
          <button onclick="fun();" style="    padding-left: 100px;
    padding-right: 100px;
    padding-bottom: 5px !important;" class="btn btn-success">حسنا</button>
     </div>
   </div>
    </div>
</div>--%>
   ...
   <script>
        ...
        var bb = document.getElementById("di");
        // Get the button that opens the modal
        var btn = document.getElementById("di");
        ...
        bb.onclick = function () {
         ...
         span.onclick = function () {
             ...
             window.location.replace( "Reports.aspx");
        ...
        $("#txtSearch").autocomplete({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    ...
                    url: "EditPage.aspx/GetCountryNames",
